...
using Infraestrutura.Pokemon.Models;
using Infraestrutura.Pokemon.Providers;
using Infraestrutura.Pokemon.Results;

namespace Infraestrutura.Pokemon.Controllers
{
    [Authorize]
